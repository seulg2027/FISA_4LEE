...
<b>배운 점</b>
프로젝트가 어떤 식으로 진행되는지, 문제가 생겼을 때 어떻게 해결하는지 배울 수 있는 시간이었다.

<b>아쉬운 점</b>
이런 프로젝트가 처음이라 많은 도움이 되고 싶었지만, 도움이 못 돼서 아쉬움이 많이 남고 팀원들에게 미안함도 많다. 

<b>느낀 점</b>
팀원들 덕분에 프로젝트를 진행할 수 있었다. 고맙다는 말을 전하고 싶다.
아쉬웠던 점을 보완하여 다음번 프로젝트 때는 조금 더 팀에 기여할 수 있는 팀원이 되고 싶다.
다들 고생하셨습니다.
</pre>
<pre>
<b>이슬기</b>
...
<b>성과</b>
조그만 프로젝트였지만 오랜만에 여러 명의 팀원들과 하나의 프로젝트 기획, 설계, 개발, 완성이라는 목표로 활동할 수 있었다.
분업화를 하고 함께 목표를 달성하기 위해 자신의 역할만 하는 것이 아니라 서로서로 도와주었다.😆

<b>배운 점</b>
DB 서버를 다룰 때 처음 보는 에러를 마주쳤는데, 관련 설정에 대해서 배울 수 있었다.

<b>아쉬운 점</b>
중간에 팀원들과 업무 공유가 명확하게 이루어지지 않아 하나의 일을 중복해서 처리하는 이슈가 발생했다.
앞으로 업무의 진행상황과 완료여부를 모두가 알 수 있도록 해야하는 것을 명확하게 깨달을 수 있었다.

<b>느낀 점</b>
오랫동안 개발을 하다보니 가끔 내가 왜 이 길을 택했는지 헷갈릴 때가 있다.
이번 프로젝트를 통해 그 이유를 한 번 더 상기시킬 수 있는 기회가 되었던 것 같다.
에러와 문제들을 부딪히면서 짧은 시간 내에 해결해야한다는 압박이 있어 마음이 조급해지기도 했지만, 하나씩 풀어나가는 게 재미있었다.
</pre>
<pre>
<b>이성빈</b>
<br>
...
<br>
<b>성과</b>
React 개발을 통해 웹 애플리케이션의 프론트엔드 구현을 완료하고
Spring과의 연결을 통해 백엔드와의 통신하였다.

<br><b>배운점 및 아쉬운점</b>
이번 프로젝트를 통해 앞서 배운 Spring 코드 작성에 대한 이해도가 높아졌고, <br>향후에는 더 많은 부분에서 Spring 코드 작성에 더 기여할 수 있도록 노력해야겠다고 느꼈다.
팀원들과 프로젝트를 통해 협업하며 다양한 개발 경험을 쌓을 수 있는 좋은 기회였다.
Git을 사용하면서 폴더 경로 지정 및 기본 사용에 아직 어려움을 겪었지만 팀원들과 해결해나가는 과정이 의미있었다.<br>
</pre>
<br><br>
